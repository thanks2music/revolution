...
| `pnpm --filter @revolution/ai-writer test:e2e` | Layer 3 E2E (Vision API 実 key 必要、AI Writer 配下のみ、PR #217 で分離) |
...
cp .env.sample .env.local  # 環境変数テンプレート (SSOT、要 API key 設定)
```
